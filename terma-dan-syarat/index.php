                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 px-4">
                            <div class="text-editor">
                                ...
                                <p class="mb-3">Sila baca dengan teliti Terma dan Syarat berikut sebelum menggunakan laman web dan perkhidmatan WINMY. Dengan mengakses dan menggunakan <a href="<?php echo $site_base_url;?>/muat-turun-apk"><strong>winmy apk</strong></a>, anda bersetuju untuk mematuhi semua peraturan dan syarat yang dinyatakan.</p>
                                <ol>
                                    ...
                                    <li class="mb-3"><strong>Kebenaran dan Kelulusan</strong><br/>WINMY berhak menolak atau menggantung akaun tanpa memberi notis jika terdapat pelanggaran terma atau aktiviti mencurigakan.</li>
                                    ...
                                    <li class="mb-3"><strong>Perubahan Terma dan Syarat</strong><br/>WINMY berhak mengubah <a href="<?php echo $site_base_url;?>/terma-dan-syarat"><strong>terma dan syarat</strong></a> ini pada bila-bila masa tanpa notis terlebih dahulu. Penggunaan berterusan selepas perubahan bermakna anda menerima syarat baru tersebut.</li>
